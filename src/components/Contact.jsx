    ...
    return (
        <div>
            ...
            <div className='m-auto text-center bg-gray-100 py-10 px-6 mx-4 rounded-lg sm:mx-20 md:mx-28'>
                ...
                <p className='my-4 w-10/12 text-center m-auto' style={{ color: '#45595b' }}>Have questions or need help? Contact us for the freshest fruits and veggies delivered to your door!</p>
                <div className=" rounded w-10/12 h-96 mx-auto my-8">
                    {/* <iframe className="rounded w-full h-full"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d448196.5259053188!2d76.76357451215983!3d28.64368472633456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e0!3m2!1sen!2sin!4v1754541168693!5m2!1sen!2sin" 
                    ...
                    <iframe
                        ...
                        title="Map showing Delhi location"
                    />
                    ...
                    <div className='lg:w-5/12'>
                        <div className='bg-white my-4 rounded-lg flex items-center py-6 px-2'>
                            ...
                            <div className='flex flex-col items-start justify-start ml-6'>
                                ...
                                <span className='w-fit' style={{ color: '#45595b' }}>Karala, Delhi-110081, India</span>
                            </div>
                        </div>
                        <div className='bg-white my-4 rounded-lg flex items-center py-6 px-2'>
                            ...
                            <div className='flex flex-col items-start justify-start ml-6'>
                                ...
                                <span className='w-fit' style={{ color: '#45595b' }}>jeeshankmr2004@gmail.com</span>
                            </div>
                        </div>
                        {/* <div className='bg-white my-4 rounded-lg flex items-center py-6 px-2'>
                            ...
                            <div className='flex flex-col items-start justify-start ml-6'>
                                ...
                                <span className='w-fit' style={{color: '#45595b'}}></span>
                            </div>
                        </div> */}
                    </div>
                </div>
