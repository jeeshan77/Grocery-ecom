    ...
    return (
        <div className='mt-40 px-6 py-10 sm:px-20 md:px-24 lg:px-16 xl:px-20' style={{ backgroundColor: '#45595b' }}>
            <div className='py-10 lg:grid lg:grid-cols-3 lg:items-center xl:flex xl:justify-between '>
                <div>
                    <h1 className='text-3xl font-semibold lg:text-4xl lg:grid-cols-1' style={{ color: '#81c408' }}>FreshRootz</h1>
                ...
                <ul className="flex justify-end">
                    <li className="mx-1">
                        <a href="https://x.com/jeeshan7704" target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-twitter py-3 px-3 social rounded-full border border-orange-400"></i>
                        </a>
                    </li>
                    <li className="mx-1">
                        <a href="https://github.com/jeeshan77" target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-github py-3 px-3 social rounded-full border border-orange-400"></i>
                        </a>

                    </li>
                    <li className="mx-1">
                        <a
                            href="mailto:jeeshankmr2004@gmail.com?subject=Hello&body=Hello, my email is jeeshankmr2004@gmail.com"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <i className="fas fa-envelope py-3 px-3 social rounded-full border border-orange-400"></i>
                        </a>

                    </li>
                    <li className="mx-1">
                        <a href="https://www.linkedin.com/in/jeeshan-gosain/" target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-linkedin-in py-3 px-3 social rounded-full border border-orange-400"></i>
                        </a>
                    </li>
                </ul>
            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-y-8 lg:grid-cols-4'>
                <div>
                    ...
                    <p className='footer-contact mt-4 md:w-60 lg:w-44 xl:w-56'>At FreshRootz, we’re committed to delivering the freshest fruits and vegetables right to your doorstep.
                        Customers love us for our unbeatable quality, fast and reliable delivery, and affordable prices.</p>
                ...
                <div>
                    ...
                    <ul className='mt-5 '>
                        <li className="footer-body">
                            <a href="https://jeeshan77.github.io/Blog/about/" className="text-inherit hover:underline">About Us</a>
                        </li>
                        <li className="footer-body">
                            <a href="https://jeeshan77.github.io/Blog/about/" className="text-inherit hover:underline">Contact Us</a>
                        </li>
                ...
                <div>
                    ...
                    <div className='mt-5'>
                        <p className='footer-contact'>Shiv Vihar, Karala, Delhi-110081, India</p>
                        <p className='footer-contact'>Email: jeeshankmr2004@gmail.com</p>
            ...
            <div className='m-auto text-center'>
                <p className='font-medium' style={{ color: '#ffffff80' }}><strong style={{ color: '#ffb524' }}>&copy;FreshRootz </strong>All Right Reserved by Jeeshan</p>
            </div>
        </div>
    )
}
